...
#else
#define HCI_ACCESS		HCI_USE_UART				//RD_EDIT: UART enable
#endif 
...
#define TRANSITION_TIME_DEFAULT_VAL	0
	#else
#define TRANSITION_TIME_DEFAULT_VAL (GET_TRANSITION_TIME_WITH_STEP(1, 0)) // RD_EDIT: Transittion (0x41)  // 0x41: 1 second // 0x00: means no default transition time
	#endif
#endif
#endif
...
#define RangDong_8253
#ifndef RangDong_8253	//Dongle
	#define PWM_R       GPIO_PWM1A3		//red
	#define PWM_G       GPIO_PWM0A2		//green
	#define PWM_B       GPIO_PWM3B0		//blue
	#define PWM_W       GPIO_PWM4B1		//white
#endif
// RD_EDIT Module Pinout
#ifdef RangDong_8253
	#define PWM_R      GPIO_PA1 // GPIO_PC4		//Pin 24  Red		SAR ADC
	#define PWM_G      GPIO_PA1 // GPIO_PWM1C3		//Pin 23  Green
	#define PWM_B      GPIO_PA1 // GPIO_PWM0C2		//Pin 22  Blue
	#define PWM_W      GPIO_PA1 // GPIO_PWM4B4		//Pin 14  White  SAR ADC
  // #define PWM_Y		GPIO_PWM5B5		// Pin 23     SAR ADC Input PWM
#endif
