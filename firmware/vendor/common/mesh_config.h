...
#else
#define SPIRIT_VENDOR_EN			0 //must RD_EDIT: vendor En
#endif
#endif
...
#define LIGHT_TYPE_SEL				LIGHT_TYPE_PANEL
		#endif
	#else
#define LIGHT_TYPE_SEL				LIGHT_TYPE_NONE	//  //RD_EDIT Type Light
	#endif
#endif
#endif
...
#define MD_POWER_ONOFF_EN           MD_DEF_TRANSIT_TIME_EN 	// because both of them save in same flash sector.
    #endif
#define MD_TIME_EN                  0
#define MD_SCENE_EN                 1				// RD_EDIT: Scene enable
#define MD_SCHEDULE_EN              MD_TIME_EN  // because both of them save in same flash sector.
#define MD_PROPERTY_EN				0
#define	MD_LOCATION_EN				0	// location,sensor,battery use same flash addr, but one sector max store 6 models
#define MD_BATTERY_EN				0				// RD_EDIT MD_BATTERY_EN
#define MD_DF_EN					0
#define MD_SBR_EN					0
...
#define MD_SENSOR_CLIENT_EN		    1	// must 1
    #else
#define MD_SENSOR_CLIENT_EN		    1	// MD_CLIENT_EN1// RD_EDIT  MD_CLIENT_EN1
    #endif
#endif
...
#define ELE_CNT_EVERY_LIGHT         4
        #endif
    #else
#define ELE_CNT_EVERY_LIGHT         1		// RD_EDIT ELEMENT count
    #endif
#endif
...
#define MAX_LPN_NUM					16   // should be less than or equal to 16 16   RD_EDIT Friend MAX
...
#define			IRQ_TIMER1_ENABLE  			    0// RD_EDIT: enablr IQR Timer1
#define			IRQ_TIME1_INTERVAL			    (1000) //   unit: us RD_EDIT Set time interrupt 5ms
#define			IRQ_GPIO_ENABLE  			    0// RD_EDIT enable Interrupt GPIO
